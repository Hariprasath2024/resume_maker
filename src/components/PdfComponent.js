...
function PdfComponent() {
 ...
 const [c,cf]=useState("d-flex align-items-center justify-content-center col-md-5 bg-1 p-0 py-2")
 
  const change=()=>{
   
      cf("d-flex align-items-center justify-content-center col-md-5 bg-primary p-0 py-2")
  }
  const change1=()=>{
    cf("d-flex align-items-center justify-content-center col-md-5 bg-1 p-0 py-2")
  }
  const printDocument = () => {
  ...
  <button className="nav-link align-middle bg-dark text-white p-2 rounded" onClick={change}>Template1</button>
  <button className="nav-link align-middle bg-dark text-white p-2 rounded" onClick={change1}>Template2</button>
</div>
